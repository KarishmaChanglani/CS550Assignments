...
(define part2-test
  (test-suite "Test for Part 2"
  (check-equal? (test-mceval '(stream-first (stream-rest (stream-filter prime? (stream-enumerate-interval 10000 1000000))))) 10009 "Second prime past 10000 is 10009")))
  
(run-tests delay-force-tests)
(run-tests stream-tests)
(run-tests part2-test)
